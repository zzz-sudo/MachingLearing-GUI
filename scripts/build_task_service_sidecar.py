...
def run() -> None:
    ...
    command = [
        ...
        "--add-data",
        f"{SERVICE_ROOT / 'app' / 'algorithm_runners' / 'clustering.py'}{os.pathsep}app/algorithm_runners",
        "--add-data",
        ...
        "--add-data",
        f"{SERVICE_ROOT / 'app' / 'algorithm_runners' / 'hypothesis.py'}{os.pathsep}app/algorithm_runners",
        "--add-data",
        f"{SERVICE_ROOT / 'app' / 'algorithm_runners' / 'exploration.py'}{os.pathsep}app/algorithm_runners",
        "--add-data",
        f"{SERVICE_ROOT / 'app' / 'visualization' / '__init__.py'}{os.pathsep}app/visualization",
        "--add-data",
